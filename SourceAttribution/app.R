...
ui <- fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(splitLayout(
            ...
            # spans both models
            p(paste0('Outbreak Source Prediction Tool ',
                     ...
                     'for Disease Control and Prevention (link: ', 
                     'https://www.cdc.gov/nors/index.html). <br>', 
                     ...
                     "investigation, visit COFoodSafety.org")
              ), 
            style = 'width:550px;'

...
preprocessing. Parsnip was used for the null model. The r 
...
the test set. The brier score is a measurement of the accuracy of probablilitic
predictions of mutually exclusive outcomes. It is the sum of the differences 
between the predicted probability and the observed outcome (equal to zero if 
the outcome did not occur, one if it did) squared summed across all outbreaks. 
(Fig 2)
